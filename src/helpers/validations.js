...
export const FORM_RULES = {
    ...
    minValue: min => value => value && parseFloat(value) < parseFloat(min) ? `O valor deve ser maior que ${min}` : undefined,
    maxValue: max => value => value && parseFloat(value) > parseFloat(max) ? `O valor deve ser menor que ${max}` : undefined,
    maxValueExact: max => value => value && value == max ? `O valor do desconto deve ser igual a ${max}` : undefined,
...
// export const max30 = FORM_RULES.maxValue(30)

// export const min1 = FORM_RULES.minValue(1)
